    ...
    >
      <div ref={ref} className="relative max-w-7xl mx-auto px-4 md:px-10">
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-[#2e2e2e] to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]"
        >
          <motion.div
            style={{
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-[#b520fe] via-[#b520fe] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
